<div class="panel-body">
    ...
    <div class="table-responsive">
        <table id="herotable00" class="table table-bordered" style="width:100%">
            <thead>
            <tr>
                <th class="text-center" width="10%">Kriteria</th>
            ...
            <?php
                foreach ($query->result() as $row) {
                    ...
                    //         <form class='form-inline' action='".base_url()."kriteria/editBobot' method='post'>
                    //             <div class='form-group'>
                    //                 <input type='text' class='form-control text-center' name='bobot' value='".$row->bobot_krt."'>
                    //                 <input type='hidden' class='form-control' name='id' value='".$row->id_krt."'>
                    //                 <input type='hidden' class='form-control' name='nama' value='".$row->nama_krt."'>
                    //             </div>
